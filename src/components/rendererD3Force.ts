...
export interface DRRendererD3ForceConfig extends DRRendererD3Config {
  width: number;
  height: number;
...
export interface DRNodeD3Force extends DRNodeD3 {
  group: number;
  size: number;
  childCount: number;
  parentCount: number;
...
export default class DRRendererD3Force extends DRRendererD3 {
  ...
  constructor(public container: HTMLElement, public config: any = DEFAULT_CONFIG) {
  ...
  public transformNode(element: HTMLElement): DRNodeD3Force {
